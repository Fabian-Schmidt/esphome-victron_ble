...
CONF_SUPPORTED_TYPE = {
    ...
    "SOLAR_CHARGER_DEVICE_STATE":  {
        CONF_TYPE: VICTRON_SENSOR_TYPE_dummy_ns.SOLAR_CHARGER_DEVICE_STATE,
    },
    "SOLAR_CHARGER_CHARGER_ERROR":  {
        CONF_TYPE: VICTRON_SENSOR_TYPE_dummy_ns.SOLAR_CHARGER_CHARGER_ERROR,
    },
    "SOLAR_CHARGER_BATTERY_VOLTAGE":  {
        CONF_TYPE: VICTRON_SENSOR_TYPE_dummy_ns.SOLAR_CHARGER_BATTERY_VOLTAGE,
        CONF_UNIT_OF_MEASUREMENT: UNIT_VOLT,
    ...
    "SOLAR_CHARGER_BATTERY_CURRENT":  {
        CONF_TYPE: VICTRON_SENSOR_TYPE_dummy_ns.SOLAR_CHARGER_BATTERY_CURRENT,
        CONF_UNIT_OF_MEASUREMENT: UNIT_AMPERE,
        CONF_ICON: ICON_POWER,
        CONF_ACCURACY_DECIMALS: 1,
        CONF_DEVICE_CLASS: DEVICE_CLASS_CURRENT,
    ...
    "SOLAR_CHARGER_YIELD_TODAY":  {
        CONF_TYPE: VICTRON_SENSOR_TYPE_dummy_ns.SOLAR_CHARGER_YIELD_TODAY,
    ...
    "SOLAR_CHARGER_PV_POWER":  {
        CONF_TYPE: VICTRON_SENSOR_TYPE_dummy_ns.SOLAR_CHARGER_PV_POWER,
    ...
    "SOLAR_CHARGER_LOAD_CURRENT":  {
        CONF_TYPE: VICTRON_SENSOR_TYPE_dummy_ns.SOLAR_CHARGER_LOAD_CURRENT,
        CONF_UNIT_OF_MEASUREMENT: UNIT_AMPERE,
        CONF_ICON: ICON_POWER,
        CONF_ACCURACY_DECIMALS: 1,
        CONF_DEVICE_CLASS: DEVICE_CLASS_CURRENT,
