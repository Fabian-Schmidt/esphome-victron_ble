...
# `VICTRON_SENSOR_TYPE` is a enum class and not a namespace but it works.
VICTRON_SENSOR_TYPE_dummy_ns = victron_ble_ns.namespace("VICTRON_SENSOR_TYPE")

CONF_SUPPORTED_TYPE = {
    "BATTERY_MONITOR_TIME_TO_GO":  {
        CONF_TYPE: VICTRON_SENSOR_TYPE_dummy_ns.BATTERY_MONITOR_TIME_TO_GO,
    ...
    "BATTERY_MONITOR_BATTERY_VOLTAGE":  {
        CONF_TYPE: VICTRON_SENSOR_TYPE_dummy_ns.BATTERY_MONITOR_BATTERY_VOLTAGE,
    ...
    "BATTERY_MONITOR_ALARM_REASON":  {
        CONF_TYPE: VICTRON_SENSOR_TYPE_dummy_ns.BATTERY_MONITOR_ALARM_REASON,
    },
    "BATTERY_MONITOR_AUX_VOLTAGE":  {
        CONF_TYPE: VICTRON_SENSOR_TYPE_dummy_ns.BATTERY_MONITOR_AUX_VOLTAGE,
        CONF_UNIT_OF_MEASUREMENT: UNIT_VOLT,
        CONF_ICON: ICON_BATTERY,
        CONF_ACCURACY_DECIMALS: 2,
        CONF_DEVICE_CLASS: DEVICE_CLASS_VOLTAGE,
    ...
    "BATTERY_MONITOR_MID_VOLTAGE":  {
        CONF_TYPE: VICTRON_SENSOR_TYPE_dummy_ns.BATTERY_MONITOR_MID_VOLTAGE,
        CONF_UNIT_OF_MEASUREMENT: UNIT_VOLT,
        CONF_ICON: ICON_BATTERY,
        CONF_ACCURACY_DECIMALS: 2,
        CONF_DEVICE_CLASS: DEVICE_CLASS_VOLTAGE,
    ...
    "BATTERY_MONITOR_TEMPERATURE":  {
        CONF_TYPE: VICTRON_SENSOR_TYPE_dummy_ns.BATTERY_MONITOR_TEMPERATURE,
    ...
    "BATTERY_MONITOR_BATTERY_CURRENT":  {
        CONF_TYPE: VICTRON_SENSOR_TYPE_dummy_ns.BATTERY_MONITOR_BATTERY_CURRENT,
    ...
    "BATTERY_MONITOR_CONSUMED_AH":  {
        CONF_TYPE: VICTRON_SENSOR_TYPE_dummy_ns.BATTERY_MONITOR_CONSUMED_AH,
    ...
    "BATTERY_MONITOR_STATE_OF_CHARGE":  {
        CONF_TYPE: VICTRON_SENSOR_TYPE_dummy_ns.BATTERY_MONITOR_STATE_OF_CHARGE,
        CONF_UNIT_OF_MEASUREMENT: UNIT_AMPERE,
        CONF_ICON: ICON_BATTERY,
        CONF_ACCURACY_DECIMALS: 3,
        CONF_DEVICE_CLASS: DEVICE_CLASS_CURRENT,
